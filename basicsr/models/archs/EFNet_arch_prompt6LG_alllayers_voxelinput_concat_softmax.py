...
#                 img.save(f"/home/work/data/code/EFNet_original/EFNet/experiments/result_weight_nhwc_dilation/{counter}/{each_batch}/prompt_weight_{_}.png")
        ...
        for i, down in enumerate(self.down_path_1):
            if (i+1) < self.depth:
                ...
                x1, x1_up = down(x1, event_filter=ev[i], edge=edge, merge_before_downsample=self.fuse_before_downsample, counter=counter)
                encs.append(x1_up)
                ...
                x1 = down(x1, event_filter=ev[i], edge=edge, merge_before_downsample=self.fuse_before_downsample, counter=counter)
...
class UNetConvBlock(nn.Module):
    ...
    def forward(self, x, edge=None, enc=None, dec=None, mask=None, event_filter=None, merge_before_downsample=True, counter=0):
        out = self.conv_1(x)
...
#                         img.save(f"/home/work/data/code/EFNet_original/EFNet/experiments/result_weight_nhwc_dilation_prompt6_softmax/{counter}/{each_level}/prompt_weight_{_}.png")
        ...
        if self.downsample:
            ...
            if not merge_before_downsample: 
                ...
                prompt_weight_map_down = self.prompt_weight(out_edge_down)
