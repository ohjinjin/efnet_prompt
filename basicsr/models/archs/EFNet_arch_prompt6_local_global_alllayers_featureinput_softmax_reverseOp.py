...
import math
from basicsr.models.archs.arch_util import EventImage_w_promptLG_reverse_ChannelAttentionTransformerBlock, PromptMapGenBlock, PromptMapGenBlock1D
...
class UNetConvBlock(nn.Module):
    def __init__(self, in_size, out_size, downsample, relu_slope, prompt_num=None, stride_promptweight=None, use_emgc=False, num_heads=None): # cat
        ...
        if self.num_heads is not None:
            ...
            self.image_event_transformer = EventImage_w_promptLG_reverse_ChannelAttentionTransformerBlock(out_size, num_heads=self.num_heads, ffn_expansion_factor=4, bias=False, LayerNorm_type='WithBias')
...
#                         img.save(f"/home/work/data/code/EFNet_original/EFNet/experiments/result_weight_nhwc_dilation_prompt6_softmax/{counter}/{each_level}/prompt_weight_{_}.png")
    ...
    #                         img.save(f"/home/work/data/code/EFNet_original/EFNet/experiments/result_weight_nhwc_dilation_prompt6_softmax/{counter}/{each_level}/prompt_weight_{_}.png")
                ...
                out_down = self.image_event_transformer(out_down, event_filter, prompt_local_down, prompt_global_down) 
